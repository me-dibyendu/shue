    ...
    <View>
      ...
      <ScrollView style={{ backgroundColor: Constants.colors.white }}>
        <View style={{ paddingBottom: Constants.padding + 100 }}>
          <View>
            <Image source={Images.coverPic} style={styles.coverPic} />
          </View>
          <View style={styles.afterCoverPic}>
            <View style={styles.brandNameContainer}>
              <Text style={{ fontFamily: Constants.fontFamily.RobotoBold, fontSize: 34, color: Constants.colors.white, position: 'absolute', top: -60, left: -42, color: Constants.colors.primary, backgroundColor: Constants.colors.white, padding: 17, borderRadius: Constants.borderRadius, }}>AS</Text>
            </View>
          ...
          <View style={styles.heading}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              ...
              <Text style={{ fontFamily: Constants.fontFamily.PoppinsMedium, fontSize: 18, color: Constants.colors.primary }}>Preorder</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Pressable onPress={allTopSellingCategory}><Text style={styles.viewAll}>View All <Icon name='right' size={10} /></Text></Pressable>
            </View>
          </View>
          <View style={{ marginStart: Constants.margin, }}>
            <NewReleaseSlider />
          </View>
          ...
          <View style={styles.heading}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Pressable onPress={allTopSellingCategory}><Text style={styles.viewAll}>View All <Icon name='right' size={13} /></Text></Pressable>
            </View>
          </View>
          ...
          <View style={styles.heading}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Image source={Images.categoryIcon} style={{ width: 32, height: 32, marginRight: 8 }} />
              <Text style={{ fontFamily: Constants.fontFamily.PoppinsMedium, fontSize: 17, color: Constants.colors.primary }}>Top Selling Category</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Pressable onPress={allTopSellingCategory}><Text style={styles.viewAll}>View All <Icon name='right' size={13} /></Text></Pressable>
            </View>
          ...
          <View style={styles.heading}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Image source={Images.sortbysize} style={{ width: 32, height: 32, marginRight: 8 }} />
              <Text style={{ fontFamily: Constants.fontFamily.PoppinsMedium, fontSize: 17, color: Constants.colors.primary }}>Short By Size</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Pressable onPress={allTopSellingCategory}><Text style={styles.viewAll}>View All <Icon name='right' size={13} /></Text></Pressable>
            </View>
          ...
          <View style={styles.heading}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Image source={Images.treanding} style={{ width: 32, height: 32, marginRight: 8 }} />
              <Text style={{ fontFamily: Constants.fontFamily.PoppinsMedium, fontSize: 17, color: Constants.colors.primary }}>Trending Products</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Pressable onPress={allTopSellingCategory}><Text style={styles.viewAll}>View All <Icon name='right' size={13} /></Text></Pressable>
            </View>
          ...
          <View style={styles.heading}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Image source={Images.reviewIcon} style={{ width: 32, height: 32, marginRight: 8 }} />
              <Text style={{ fontFamily: Constants.fontFamily.PoppinsMedium, fontSize: 17, color: Constants.colors.primary }}>Review</Text>
            </View>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
              <Pressable onPress={allTopSellingCategory}><Text style={styles.viewAll}>View All <Icon name='right' size={13} /></Text></Pressable>
            </View>
