...
const Signup = (props) => {
    ...
    const gotoResellerLogin = () => {
        props.navigation.navigate('ResellerLogin')
    }
    const memberSignup = () => {
        ...
        <View style={{ flex: 1, backgroundColor: Constants.colors.white, }}>
            <ScrollView style={{ flex: 1, }}>
                ...
                <View style={styles.body}>
                    <View style={styles.loginTextContainer}><Text style={styles.loginText}>Sign Up</Text></View>
                    ...
                    <Pressable style={styles.button} onPress={memberSignup}><Text style={styles.buttonText}>Sign Up</Text></Pressable>
                    <View style={styles.signupLink}>
                        <Text style={styles.notAmember}>Already a Member </Text><Pressable onPress={gotoLogin}><Text style={styles.signupText}>Log In</Text></Pressable>
                    </View>
