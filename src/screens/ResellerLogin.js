...
import { userType } from '../shared/redux/features/users.slice'
...
const ResellerLogin = (props) => {
  ...
  const gotoResellerSignup = ()=>{
    navigation.navigate('ResellerSignup')
  }
  ...
  const resellerLogin = ()=>{
    dispatch(userType('reseller'))
    props.updateUserType('reseller')
  }
  return (
    <View style={{ flex: 1, backgroundColor: Constants.colors.white, }}>
      <ScrollView style={{ flex: 1, }}>
        ...
        <View style={styles.body}>
          <View style={styles.loginTextContainer}><Text style={styles.loginText}>Reseller Log In</Text></View>
          ...
          <Pressable style={styles.button} onPress={resellerLogin}><Text style={styles.buttonText}>Log In</Text></Pressable>
          <View style={styles.signupLink}>
            <Text style={styles.notAmember}>Not a Reseller </Text><Pressable onPress={gotoResellerSignup}><Text style={styles.signupText}>Sign Up</Text></Pressable>
          </View>
          <Pressable style={styles.button} onPress={gotoMemberLogin}><Text style={styles.buttonText}>Member Log In</Text></Pressable>
        </View>
      </ScrollView>
    </View>
  )
