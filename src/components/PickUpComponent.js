        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <View style={styles.heading}>
                <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Constants.margin, marginBottom: Constants.margin, }}>
                    ...
                    <Text style={{ fontFamily: Constants.fontFamily.PoppinsMedium, fontSize: 17, color: Constants.colors.primary, marginLeft: 12, }}>Pick Up</Text>
                </View>
            </View>
            ...
            <View>
                <View style={styles.productCard}>
                    <View style={[styles.pname, { flexDirection: 'row', alignItems: 'center', borderTopLeftRadius: Constants.borderRadius, borderTopRightRadius: Constants.borderRadius, justifyContent: 'space-between', }]}>
                        ...
                        <Pressable onPress={()=>props.handelShippingOption('pickup-selected')} style={[styles.button,{ backgroundColor: Constants.colors.white, }]}><Text style={styles.btnText}>Select</Text></Pressable>
                    </View>
                    <View>
