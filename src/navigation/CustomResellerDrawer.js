...
function CustomResellerDrawer(props) {
    return (
        <DrawerContentScrollView {...props}>
            ...
            <View style={styles.content}>
                <DrawerItem style={{
                    ...
                    onPress={() => props.navigation.navigate('ResellerHome')} />
                <DrawerItem style={{
                    borderBottomWidth: 2,
                    paddingBottom: 8,
                    borderColor: Constants.colors.grayBg,
                    ...
                    icon={() => <Fa style={styles.drawerIcon} name="tasks" />}
                    labelStyle={{ color: Constants.colors.primary, fontFamily: Constants.fontFamily.Roboto, fontSize: 16, }}
                    onPress={() => {props.navigation.navigate('ResellerRequest') }} />
                <DrawerItem style={{
                    borderBottomWidth: 2,
                    paddingBottom: 8,
                    borderColor: Constants.colors.grayBg,
...
export default CustomResellerDrawer